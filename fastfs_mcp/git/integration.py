...
try:
    ...
    from fastfs_mcp.git.base import (
        # Helper functions
    ...
    from fastfs_mcp.git.advanced import (
    ...
    from fastfs_mcp.git.enhanced import (
    ...
    # Import SSH support
    from fastfs_mcp.git.ssh import (
        SSHCredential, SSHConfig, SSHKeyManager
    )
    
    # Import error handling
    from fastfs_mcp.git.error_handler import (
...
class PyGit2Integration:
    ...
    def get_api_documentation(self) -> Dict[str, Any]:
        ...
        modules = [
            {"path": "fastfs_mcp/git/base.py", "name": "Basic Git Operations"},
            {"path": "fastfs_mcp/git/advanced.py", "name": "Advanced Git Operations"},
            {"path": "fastfs_mcp/git/enhanced.py", "name": "Enhanced Features"},
            {"path": "fastfs_mcp/git/ssh.py", "name": "SSH Support"},
            {"path": "fastfs_mcp/git/error_handler.py", "name": "Error Handling"}
        ]
